...
export const enrollService = {
  getAll: (courseId, params) =>
    api.get(`/api/tms/course/${courseId}/enrollments`, { params }),
  getById: (courseId, enrollmentId) =>
    api.get(`/api/tms/course/${courseId}/enrollments/${enrollmentId}`),
  enroll: (courseId, data) =>
    api.post(`/api/tms/course/${courseId}/enrollments`, data),
  updateProgress: (courseId, data) =>
    api.put(`/api/tms/course/${courseId}/enrollments`, data),
  delete: (courseId, enrollmentId) =>
    api.delete(`/api/tms/course/${courseId}/enrollments/${enrollmentId}`),
};
...
export const attendanceService = {
  getAll: (sessionId, params) =>
    api.get(`/api/tms/session/${sessionId}/attendance`, { params }),
  getById: (sessionId, attendanceId) =>
    api.get(`/api/tms/session/${sessionId}/attendance/${attendanceId}`),
  create: (sessionId, data) =>
    api.post(`/api/tms/session/${sessionId}/attendance`, data),
  update: (sessionId, data) =>
    api.put(`/api/tms/session/${sessionId}/attendance`, data),
  updateStatus: (sessionId, attendanceId, status) =>
    api.patch(`/api/tms/session/${sessionId}/attendance/${attendanceId}`, null, {
      params: { status },
    }),
  delete: (sessionId, attendanceId) =>
    api.delete(`/api/tms/session/${sessionId}/attendance/${attendanceId}`),
};
